                          ...
                          <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                            {project.samples.map((sample, idx) => (
                              <div className="py-5" key={idx}>
                                <div className="p-5 bg-indigo-700 rounded-md bg-opacity-10" key={idx}>
                                  <img src={sample.image} alt={sample.title} className="object-cover w-full transition duration-200 ease-in rounded-md grayscale-15 hover:grayscale-0" />
                                </div>
